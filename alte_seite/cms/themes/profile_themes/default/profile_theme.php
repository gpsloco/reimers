...
{
return <<< EOF
<div class='copyright'><a href="http://expressionengine.com/">Powered by ExpressionEngine</a><br />{elapsed_time}</div>
EOF;
}
/* END */
...
<td class='profileTopBox' valign='top' style="width:50%;">
	...
	{/if}
	{if not_photo}
		<div class="itempad"><img src="{path:image_url}icon_profile.gif" width="50" height="50" border="0" title="{name}" alt="No Photo" /></div>
...
{if accept_email}
<a href="#" {email_console}><img src="{path:image_url}icon_email.gif" width="56" height="14" alt="Email Console" title="Email Console" border="0" /></a>
{/if}
</td>
...
{if aol_im}
<a href="#" {aim_console}><img src="{path:image_url}icon_aim.gif" width="56" height="14" border="0" alt="AOL IM" title="AOL IM" /></a>
{/if}
</td>
...
<td class='tableCellOne'>
{if icq}
<a href="#" {icq_console}><img src="{path:image_url}icon_icq.gif" width="56" height="14" border="0" alt="ICQ" title="ICQ" /></a>
{/if}
</td>
...
<td class='tableCellOne'>
{if yahoo_im}
<a href="{yahoo_console}" target="_blank"><img src="{path:image_url}icon_yim.gif" width="56" height="14" border="0" alt="Yahoo Messenger" title="Yahoo Messenger"></a>
{/if}
</td>
...
<tr><td style="width:118px;"><a href="aim:goim?screenname={aol_im}&message=Hi.+Are+you+there?"><img src="{path:image_url}aim_im.gif" style="width:118px;" height="40" border="0" alt="I am Online" /></a></td>
</tr><tr>
<td style="width:118px;"><a href="aim:addbuddy?screenname={aol_im}"><img src="{path:image_url}aim_buddy.gif" style="width:118px;" height="40" border="0" alt="Add me to your Buddy List" /></a></td>
</tr><tr>
...
<div class="lighttext">{lang:max_size}&nbsp;{lang:max_file_size} KB</div>
</td>
<td class="tableCellTwo">
...
<div class='itempadbig'>&nbsp;<input  type='submit' class='submit' value='Submit'  /></div>
</form>
...
<a href="{path:send_pm}" title="Private Message - {screen_name}">{screen_name}</a>
</td>
