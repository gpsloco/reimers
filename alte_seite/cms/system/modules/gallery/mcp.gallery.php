...
EOT;
    ...
    function insert_new_entry()
    {
		...
		// Get gallery comment expiration 
		$q = $DB->query("SELECT gallery_comment_expiration from exp_galleries WHERE gallery_id = '". $this->gallery_id ."'");
		$expiration = $q->row['gallery_comment_expiration'] * 86400;

		$expiration_date = ($expiration === 0) ? 0 : $LOC->now + $expiration;
		...
		$data = array(
						...
						'comment_expiration_date' => $expiration_date,
...
EOT;
    ...
    {
		global $IN, $DSP, $DB, $LANG, $LOC, $PREFS, $FNS, $REGX;
		...
		$default = array(
						...
						'gallery_wm_text'						=> 'Copyright '.date('Y', $LOC->now),
