...
class Template {
   ...
   // END
	...
	function advanced_conditionals($str)
	{
		...
		$opener = $FNS->unique_marker('tmpl_php_open');
		$closer = $FNS->unique_marker('tmpl_php_close');
    	...
    	$protected = array();
    	$front_protect = $FNS->unique_marker('tmpl_script_open');
    	$back_protect  = $FNS->unique_marker('tmpl_script_close');
