...
=====================================================
 File: ud_110.php
-----------------------------------------------------
 Purpose: Perform version 1.1 update
=====================================================
*/
...
class Updater {
	...
	function do_update()
	{
		...
		if (isset($conf['captcha_require_members']))
		{
			return TRUE;
		}
		...
		$data = array(
						...
						'save_tmpl_files'   		=>  'n',
						'tmpl_file_basepath'   		=>  '',
						'calendar_thumb_path'		=>	$UD->conf['site_url'].'images/cp_images/calendar.gif',
						'cp_image_path'				=>	$UD->conf['site_url'].'images/cp_images/',
...
class Category_Order {
    ...
    function add_category_orders()
    {
    	...
    	$query = $DB->query("SELECT group_id FROM exp_category_groups");
    	...
    	foreach($update_array as $group_data)
    	{
    		...
    		{
    			$DB->query("UPDATE exp_categories
...
// END CLASS
	...
	function update_skin()
	{
			...
			$str .= '-----------------------------------------------------'."\n";
			$str .= ' Copyright (c) 2003 - 2011 EllisLab, Inc.'."\n";
			$str .= '====================================================='."\n";
